...
"""
pages documentation build configuration file.
...
project_title = 'Pages with hierarchical structure'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Pages with hierarchical structure',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'pages'),
                os.path.join(root_path, 'pages/migrations')])
